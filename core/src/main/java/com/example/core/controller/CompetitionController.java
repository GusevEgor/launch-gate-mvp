...
public class CompetitionController {
    ...
    public CompetitionInfoFullResponse createCompetition(@RequestBody CompetitionFullInfoRequest request) {
    ...
    public CompetitionInfoFullResponse createCompetition(@PathVariable Long id) {
     ...
     * @return {@link List}{@code <}{@link CompetitionInfoSmallResponse}{@code >}
     */
    @LogBefore
    @GetMapping("get-all")
    @Operation(summary = "Получение списка мероприятий с пагинацией")
    public List<CompetitionInfoSmallResponse> getAllCompetition(
